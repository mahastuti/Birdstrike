    ...
    const where = {
      ...(search && {
        OR: [
          ...
          { ata: { contains: search, mode: 'insensitive' as const } },
          { block_on: { contains: search, mode: 'insensitive' as const } },
          { block_off: { contains: search, mode: 'insensitive' as const } },
          { atd: { contains: search, mode: 'insensitive' as const } },
          { ground_time: { contains: search, mode: 'insensitive' as const } },
          { org: { contains: search, mode: 'insensitive' as const } },
          { des: { contains: search, mode: 'insensitive' as const } },
          { ps: { contains: search, mode: 'insensitive' as const } },
          { runway: { contains: search, mode: 'insensitive' as const } },
          { avio_a: { contains: search, mode: 'insensitive' as const } },
          { avio_d: { contains: search, mode: 'insensitive' as const } },
