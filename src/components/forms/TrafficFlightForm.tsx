      ...
      <div className="bg-gray-100 border-2 border-gray-300 rounded-lg p-4">
        ...
        {showInstructions && (
          <div className="mt-4 space-y-3 text-black">
            ...
            <div className="font-medium">2. Kolom pada data tersebut tidak bisa langsung dibaca karena bentuknya seperti ini:</div>
            ...
            <div className="bg-white p-3 rounded border">
              ...
              <div className="mt-3">
                <a
                  href="https://docs.google.com/spreadsheets/d/1YJZFgLFW9fScJfltQLx55r4D8myrL9wZ/edit?usp=sharing"
                  target="_blank"
            ...
            <div className="font-medium">Jika mengupload data baru yang memiliki "bulan" dan "tahun" yang sama maka akan replace data yang sudah ada</div>
